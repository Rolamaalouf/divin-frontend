      ...
      <div className="max-w-6xl mx-auto -mt-20 bg-white rounded-lg shadow-lg p-8 relative z-10">
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="md:w-1/2 w-full">
            <p className="text-[#A68F7B] text-xl md:text-2xl mb-8">
          ...
          <div className="md:w-1/2 w-full flex flex-col items-center text-center space-y-6">
            ...
            <div className="flex items-center space-x-2 text-gray-600 justify-center">
              <MapPin className="w-5 h-5 text-[#A68F7B]" />
              <span className="text-lg font-medium">Wadi Chahrour Al Oulya, Mount Lebanon</span>
            </div>
