...
export default function OrdersPage() {
  ...
  const [paymentMethod, setPaymentMethod] = useState("card") // card | cod | wish
    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      {step === 1 && (
        <>
          ...
          <button onClick={handleNext} className="mt-8 bg-[#A68F7B] text-white p-3 w-full rounded">
            Continue to Payment
          </button>
        </>
      )}
      ...
      {step === 3 && (
        <>
          ...
          <div className="mb-2">
            <strong>Payment Method:</strong> {paymentMethod === "card" ? "Credit Card" : paymentMethod === "cod" ? "Cash on Delivery" : "Wish Money"}
          </div>
      ...
      {step === 4 && (
        <div className="text-center">
          ...
          <button
            ...
            className="bg-[#A68F7B] text-white p-3 rounded"
          >
            Return to Shopping
          </button>
        </div>
